...
CREATE OR REPLACE PACKAGE BODY xwrl_data_processing AS
   ...
   PROCEDURE process_wc_data_individual IS
   ...
   BEGIN
      ...
      v_server := xwrl_utils.get_primary_server(v_instance);
   ...
   PROCEDURE process_wc_data_entity IS
   ...
   PROCEDURE process_ows_error_resubmit IS
