...
CREATE OR REPLACE PACKAGE BODY xwrl_data_processing AS
   ...
   BEGIN
      ...
      -- Note: This is a placeholder.  At some point, need to calculate capacity of both servers up, primary only and secondary only.  Waiting for JVM tuning to be completed.
      CASE v_edq
      WHEN 3 THEN NULL;
      WHEN 2 THEN NULL;
      WHEN 1 THEN  v_max_jobs := v_max_jobs / v_ratio;
      WHEN 0 THEN  isowsavailable := false;
      END CASE;
