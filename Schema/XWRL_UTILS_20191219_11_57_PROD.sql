...
FUNCTION get_frequency RETURN INTEGER AS
   ...
   BEGIN
      ...
      insert /*+ append */ into xwrl_requests VALUES v_request_rec;
...
,x.CustomNumber5
   ...
   BEGIN
      ...
      FOR c1rec IN c1 LOOP
         ...
         insert /*+ append */ into xwrl_request_ind_columns
         VALUES v_rec;
   ...
   BEGIN
      ...
      FOR c1rec IN c1 LOOP
		...
		v_rec.dnLastUpdatedDate := c1rec.dnLastUpdatedDate;
         ...
         insert /*+ append */ into xwrl_response_ind_columns VALUES v_rec;
...
,x.CustomNumber5
   ...
   BEGIN
      ...
      FOR c1rec IN c1 LOOP
         ...
         insert /*+ append */ into xwrl_request_entity_columns VALUES v_rec;
   ...
   BEGIN
      ...
      FOR c1rec IN c1 LOOP
		...
		v_rec.dnLastUpdatedDate := c1rec.dnLastUpdatedDate;
         ...
         insert /*+ append */ into xwrl_response_entity_columns VALUES v_rec;
         COMMIT; -- TSUAZO 11/17/2019
...
FROM
   ...
   BEGIN
      ...
      FOR c1rec IN c1 LOOP
         ...
         insert /*+ append */ into xwrl_request_rows VALUES v_rec;
...
commit;   -- tsuazo 11/4/2019 confirming this commit is at the end of the loop.  Note. This was moved to outside the loop.
   ...
   BEGIN
      ...
      FOR c1rec IN c1 LOOP
         ...
         insert /*+ append */ into xwrl_response_rows VALUES v_rec;
  ...
  -- Save record attributes
   ...
   -- Send Request 
      ...
      END IF;
      utl_http.set_transfer_timeout(600); -- Note: Longest running job in Prod stess test is a little over 5 minutes.  Checking Load Balance ratio.
  ...
  --- Read Response 
   ...
   -- Save Record
      ...
      insert /*+ append */ into xwrl_requests VALUES v_request_rec RETURNING id INTO v_id;
   ...
   -- Parse Respone to save data
      ...
      SELECT rmi_ows_common_util.get_department (ID, 'CODE') deptcode,
       rmi_ows_common_util.get_department (ID) dept_ext,
