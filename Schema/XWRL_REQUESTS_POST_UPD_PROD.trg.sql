CREATE OR REPLACE  TRIGGER "XWRL"."XWRL_REQUESTS_POST_UPD"
/********************************************************************************************************************
* Legend : Type                                                                                                     *
* I --> Initial                                                                                                     *
* E --> Enhancement                                                                                                 *
...
* 18-DEC-2019 IRI              1.3                SAGARWAL        19-DEC-2019  R      Added Master ID               *
* 20-APR-2020 IRI              1.4                SGOEL                               Add new status type  
* 06-JUL-2020 IRI              1.5                TSUAZO          06-JUL-2020  E      Bypass Trigger Logic          *
*                                                                                                                   *
********************************************************************************************************************/
AFTER UPDATE
...
--               AND source_id = :OLD.source_id
               AND master_id = :OLD.master_id
               AND NVL (alias_id, -99) = NVL (:OLD.alias_id, -99)
               AND NVL (xref_id, -99) = NVL (:OLD.xref_id, -99)
               --
