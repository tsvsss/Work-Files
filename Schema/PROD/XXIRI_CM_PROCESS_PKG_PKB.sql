...
BEGIN
    ...
    LOOP
        ...
        BEGIN
            ...
            l_case_out_tbl(i).case_id := l_case_in_tbl(i).case_id;
            DBMS_OUTPUT.PUT_LINE('case found in IRIP1_EDQCONFIG : '
            ||l_case_in_tbl(i).case_id);
        EXCEPTION
        WHEN OTHERS THEN
            DBMS_OUTPUT.PUT_LINE('case not found in IRIP1_EDQCONFIG : '
            ||l_case_in_tbl(i).case_id);
            --l_schema := NULL;
        END;
        BEGIN
            ...
            l_case_out_tbl(i).case_id := l_case_in_tbl(i).case_id;
            DBMS_OUTPUT.PUT_LINE('case found in IRIP2_EDQCONFIG : '
            ||l_case_in_tbl(i).case_id);
        EXCEPTION
        WHEN OTHERS THEN
            DBMS_OUTPUT.PUT_LINE('case not found in IRIP2_EDQCONFIG : '
            ||l_case_in_tbl(i).case_id);
            --l_schema := NULL;
        END;
        IF l_schema IS NULL THEN
        ...
        IF (l_schema = 'IRIP1_EDQCONFIG') THEN
            ...
            EXCEPTION
            WHEN OTHERS THEN
                DBMS_OUTPUT.PUT_LINE('Error while inserting in to IRIP1_EDQCONFIG.dn_casecomment for case id '
                ||l_n_case_id);
                l_case_out_tbl(i).err_msg := l_case_out_tbl(i).err_msg
                ||'Error while inserting in to IRIP1_EDQCONFIG.dn_casecomment for case id '
                ||l_n_case_id
                ||SQLERRM
                ||' ,';
                l_case_out_tbl(i).status := 'ERROR';
            ...
            EXCEPTION
            WHEN OTHERS THEN
                DBMS_OUTPUT.PUT_LINE('Error while inserting in to IRIP1_EDQCONFIG.DN_CASETRANSITIONS for case id '
                ||l_n_case_id);
                l_case_out_tbl(i).err_msg := l_case_out_tbl(i).err_msg
                ||'Error while inserting in to IRIP1_EDQCONFIG.DN_CASETRANSITIONS for case id '
                ||l_n_case_id
                ||SQLERRM
                ||' ,';
                l_case_out_tbl(i).status := 'ERROR';
        ...
        IF (l_schema = 'IRIP2_EDQCONFIG') THEN
            ...
            EXCEPTION
            WHEN OTHERS THEN
                DBMS_OUTPUT.PUT_LINE('Error while inserting in to IRIP2_EDQCONFIG.dn_casecomment for case id '
                ||l_n_case_id);
                l_case_out_tbl(i).err_msg := l_case_out_tbl(i).err_msg
                ||'Error while inserting in to IRIP2_EDQCONFIG.dn_casecomment for case id '
                ||l_n_case_id
                ||SQLERRM
                ||' ,';
                l_case_out_tbl(i).status := 'ERROR';
            ...
            EXCEPTION
            WHEN OTHERS THEN
                DBMS_OUTPUT.PUT_LINE('Error while inserting in to IRIP2_EDQCONFIG.DN_CASETRANSITIONS for case id '
                ||l_n_case_id);
                l_case_out_tbl(i).err_msg := l_case_out_tbl(i).err_msg
                ||'Error while inserting in to IRIP2_EDQCONFIG.DN_CASETRANSITIONS for case id '
                ||l_n_case_id
                ||SQLERRM
                ||' ,';
                l_case_out_tbl(i).status := 'ERROR';
