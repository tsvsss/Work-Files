...
* B --> Bug                                                                                                         *
********************************************************************************************************************/
/*$Header: apps_populate_xwrl_party_master_individual.sql.sql 1.1 2019/11/15 12:00:00ET   IRI Exp                 $*/
/********************************************************************************************************************
* Object Type         : Script                                                                                      *
* Name                :                                                                                             *
* Script Name         : apps_populate_xwrl_party_master_individual.sql                                              *
* Purpose             :                                                                                             *
*                                                                                                                   *
   ...
   FOR cmasterrec IN cmaster LOOP
      ...
      FOR cprimaryrec IN cprimary (cmasterrec.source_table, cmasterrec.source_table_column, cmasterrec.source_table_id) LOOP -- Master
         ...
         INSERT /*+ append */ INTO xwrl_party_master (
            ...
            , cprimaryrec.passport_issuing_country_code
            , cprimaryrec.citizenship_country_code
            , cprimaryrec.residence_country_code
         ...
         FOR caliasrec IN calias (cprimaryrec.wc_screening_request_id, cmasterrec.source_table, cmasterrec.source_table_column, cmasterrec.source_table_id) LOOP -- Alias
          ...
          INSERT /*+ append */ INTO xwrl_party_alias (
            ...
            , caliasrec.passport_issuing_country_code
            , caliasrec.citizenship_country_code
            , caliasrec.residence_country_code
