...
and source_id =  826655;  -- YOUNG SIK KIM -- Master ID 501830

select *
from xwrl_party_master
where source_table = 'CORP_MAIN'
and source_table_column = 'CORP_ID'
and source_id =  1111896;  -- PRINCETON S.A.   -- Corp Number 	102816 -- Master ID 397889

select *
from xwrl_party_master
where id IN (501830,397889);
...
v_source_id :=  1111896; -- Corp Number 	102816
*/
...
select i.request_id, r.name_screened,r.case_id,i.alertid,i.rec,listid, i.listrecordtype, i.listfullname, i.x_state, n.line_number, x.record_comment, n.id note_id, n.note, n.creation_date, n.created_by
...
select i.request_id, r.name_screened,r.case_id,i.alertid,i.rec,listid, i.listrecordtype, i.listfullname, i.x_state, n.line_number, x.record_comment, n.note, n.creation_date, n.created_by
