...
//                else
                    expDate = new Date(issueDate.getTime() + 1825l * 24l * 60l * 60l * 1000l);
                    
                if (expDate != null)
                {
                    this.setEndorsementExpirationDate(new Timestamp(expDate.getTime()));
                    
                    if(getCertificateType() != null && getCertificateType().equalsIgnoreCase("OC"))
    ...
    public void setIssueDate(Timestamp value) 
    {
        if (value != null) 
        {
            try 
            {
                ...
                if(getCertificateType() != null 
                   && (getCertificateType().equalsIgnoreCase("UA") || getCertificateType().equalsIgnoreCase("CRA")))
                    expDate = new Date(issueDate.getTime() + 89l * 24l * 60l * 60l * 1000l);
                else
                {
                    if(this.getEndorsementExpirationDate() != null)
                        this.setExpirationDate(this.getEndorsementExpirationDate());
                    else
                        expDate = new Date(issueDate.getTime() + 1825l * 24l * 60l * 60l * 1000l);
                }
...
//            setAttributeInternal(TRANSPREVIOUSOC, null);
//        }
