...
// ---    Wed Jan 16 12:10:54 IST 2019
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class EditSeafarersViewRowImpl extends ViewRowImpl {
    ...
    public enum AttributesEnum {
        ...
        public int index() {
            return EditSeafarersViewRowImpl.AttributesEnum.firstIndex() + ordinal();
        }
        ...
        public static int count() {
            return EditSeafarersViewRowImpl.AttributesEnum.firstIndex() +
                   EditSeafarersViewRowImpl.AttributesEnum.staticValues().length;
        }

        public static final AttributesEnum[] staticValues() {
            if (vals == null) {
                vals = EditSeafarersViewRowImpl.AttributesEnum.values();
            }
            return vals;
        }
    }
    ...
    public static final int TRANSSHORTTEXT = AttributesEnum.TransShortText.index();
    public static final int TRANSMEDIAID = AttributesEnum.TransMediaId.index();
    public static final int COUNTRIESLOV1 = AttributesEnum.countriesLOV1.index();
    public static final int SEAFARERSTATUSLOV1 = AttributesEnum.SeafarerStatusLOV1.index();
    public static final int GENDERLOV1 = AttributesEnum.GenderLOV1.index();

    /**
     * This is the default constructor (do not remove).
     */
    public EditSeafarersViewRowImpl() {
    }
    ...
    public String getPhoto() {
        return (String) getAttributeInternal(PHOTO);
    }
    ...
    public String getTransNationality() 
    {
        try 
        {
            if (getAttributeInternal(TRANSNATIONALITY) == null && getNationality() != null) {
    ...
    /**
     * Gets the attribute value for the calculated attribute TransShortText.
     * @return the TransShortText
     */
    public String getTransShortText() {
        return (String) getAttributeInternal(TRANSSHORTTEXT);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute TransShortText.
     * @param value value to set the  TransShortText
     */
    public void setTransShortText(String value) {
        setAttributeInternal(TRANSSHORTTEXT, value);
    }

    /**
     * Gets the attribute value for the calculated attribute TransMediaId.
     * @return the TransMediaId
     */
    public BigDecimal getTransMediaId() {
        return (BigDecimal) getAttributeInternal(TRANSMEDIAID);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute TransMediaId.
     * @param value value to set the  TransMediaId
     */
    public void setTransMediaId(BigDecimal value) {
        setAttributeInternal(TRANSMEDIAID, value);
    }
    ...
    /**
     * Gets the view accessor <code>RowSet</code> SeafarerStatusLOV1.
     */
    public RowSet getSeafarerStatusLOV1() {
        return (RowSet) getAttributeInternal(SEAFARERSTATUSLOV1);
    }
