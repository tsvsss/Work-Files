...
public interface RMITradeCompApprovalAppModule extends ApplicationModule {
    ...
    void refreshTabDetails(String refreshFor);

    void updateBatchNotes(String batchNotes);

    void updateBatchNotesAssignBook(String batchNotes);

    void selectMultipleBooks(String selectBook);

    String validateUnverifySeafarerData();

    String updateBasicInfo(String updatedValue);
}
