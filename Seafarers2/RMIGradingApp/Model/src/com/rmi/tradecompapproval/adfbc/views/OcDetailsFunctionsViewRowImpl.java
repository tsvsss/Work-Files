...
// ---    Thu Nov 29 16:58:37 IST 2018
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class OcDetailsFunctionsViewRowImpl extends ViewRowImpl {
    ...
    public enum AttributesEnum {
        ...
        QualificationId,
        ResponsibilityId,
        TransLimitationsName,
        TransLevel,
        TransFunctionName,
        OcDetailsLimitationsLOV1,
        OcDetailsFunctionsLOV1;
        static AttributesEnum[] vals = null;
        ;
        private static final int firstIndex = 0;

        public int index() {
            return OcDetailsFunctionsViewRowImpl.AttributesEnum.firstIndex() + ordinal();
        }
        ...
        public static int count() {
            return OcDetailsFunctionsViewRowImpl.AttributesEnum.firstIndex() +
                   OcDetailsFunctionsViewRowImpl.AttributesEnum.staticValues().length;
        }

        public static final AttributesEnum[] staticValues() {
            if (vals == null) {
                vals = OcDetailsFunctionsViewRowImpl.AttributesEnum.values();
            }
            return vals;
        }
    }
    ...
    public static final int TRANSLIMITATIONSNAME = AttributesEnum.TransLimitationsName.index();
    public static final int TRANSLEVEL = AttributesEnum.TransLevel.index();
    public static final int TRANSFUNCTIONNAME = AttributesEnum.TransFunctionName.index();
    public static final int OCDETAILSLIMITATIONSLOV1 = AttributesEnum.OcDetailsLimitationsLOV1.index();
    public static final int OCDETAILSFUNCTIONSLOV1 = AttributesEnum.OcDetailsFunctionsLOV1.index();

    /**
     * This is the default constructor (do not remove).
     */
    public OcDetailsFunctionsViewRowImpl() {
    }
    ...
    /**
     * Gets the attribute value for the calculated attribute TransLimitationsName.
     * @return the TransLimitationsName
     */
    public String getTransLimitationsName() 
    {
        return (String) getAttributeInternal(TRANSLIMITATIONSNAME);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute TransLimitationsName.
     * @param value value to set the  TransLimitationsName
     */
    public void setTransLimitationsName(String value) {
        setAttributeInternal(TRANSLIMITATIONSNAME, value);
    }
    ...
    public String getTransLevel() {
        return (String) getAttributeInternal(TRANSLEVEL);
    }
     ...
     */
    public void setTransLevel(String value) {
        setAttributeInternal(TRANSLEVEL, value);
    }

    /**
     * Gets the attribute value for the calculated attribute TransFunctionName.
     * @return the TransFunctionName
     */
    public String getTransFunctionName() 
    {
        try 
        {
            if (getAttributeInternal(TRANSFUNCTIONNAME) == null && getQualificationId() != null) {
                ViewObjectImpl capVo = getAm().getOcDetailsFunctionsLovView1();
                ...
                if (frRows.length > 0 && frRows[0].getAttribute("LFnctFunctionName") != null &&
                    ...
                    setAttributeInternal(TRANSLEVEL, frRows[0].getAttribute("QualificationLevel"));
        ...
        return (String) getAttributeInternal(TRANSFUNCTIONNAME);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute TransFunctionName.
     * @param value value to set the  TransFunctionName
     */
    public void setTransFunctionName(String value) {
        setAttributeInternal(TRANSFUNCTIONNAME, value);
    }
    ...
    /**
     * Gets the view accessor <code>RowSet</code> OcDetailsFunctionsLOV1.
     */
    public RowSet getOcDetailsFunctionsLOV1() {
        return (RowSet) getAttributeInternal(OCDETAILSFUNCTIONSLOV1);
    }
