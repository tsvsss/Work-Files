...
// ---    Wed Nov 28 13:07:31 IST 2018
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class BooksViewRowImpl extends ViewRowImpl {
    ...
    public enum AttributesEnum {
        ...
        VerifiedDate,
        TransPreviousBooks,
        TransBooksWorkOrderNo,
        SpecialQualificationsVO,
        PreviousBooksLOV1,
        BookTypeLOV1,
        IssueTypeLOV1,
        StatusLOV1;
        ...
        public int index() {
            return BooksViewRowImpl.AttributesEnum.firstIndex() + ordinal();
        }
        ...
        public static int count() {
            return BooksViewRowImpl.AttributesEnum.firstIndex() + BooksViewRowImpl.AttributesEnum.staticValues().length;
        }

        public static final AttributesEnum[] staticValues() {
            if (vals == null) {
                vals = BooksViewRowImpl.AttributesEnum.values();
            }
            return vals;
        }
    }
    ...
    public static final int TRANSPREVIOUSBOOKS = AttributesEnum.TransPreviousBooks.index();
    public static final int TRANSBOOKSWORKORDERNO = AttributesEnum.TransBooksWorkOrderNo.index();
    public static final int SPECIALQUALIFICATIONSVO = AttributesEnum.SpecialQualificationsVO.index();
    public static final int PREVIOUSBOOKSLOV1 = AttributesEnum.PreviousBooksLOV1.index();
    ...
    public void setEndorsementIssueDate(Timestamp value)
    {
        if (value != null) 
        {
            try 
            {
                ...
                Date expDate = new Date(issueDate.getTime() + 1826l * 24l * 60l * 60l * 1000l);
                if (expDate != null)
     ...
     * @return the ViewAttr
     */
    public String getTransPreviousBooks() 
    {
        try 
        {
            if (getAttributeInternal(TRANSPREVIOUSBOOKS) == null && getDocumentPreviousId() != null) {
                ViewObjectImpl prvsBookVo = getAm().getPreviousSicdBooksView1();
                prvsBookVo.setNamedWhereClauseParam("pDocumentId", getDocumentId());
                prvsBookVo.setNamedWhereClauseParam("pSeafarerId", getSeafarerId());
                prvsBookVo.executeQuery();

                Row[] frRows = prvsBookVo.getFilteredRows("DocumentId", getDocumentPreviousId());

                if (frRows.length > 0 && frRows[0].getAttribute("BookNumber") != null) {
                    return frRows[0].getAttribute("BookNumber").toString();
                }
            }
        } catch (Exception e) {
            AdfUtils.addFormattedFacesErrorMessage("System encountered an exception while fetching data." +
        ...
        return (String) getAttributeInternal(TRANSPREVIOUSBOOKS);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute TransPreviousBooks.
     * @param value value to set the  TransPreviousBooks
     */
    public void setTransPreviousBooks(String value) {
        setAttributeInternal(TRANSPREVIOUSBOOKS, value);
    }

    /**
     * Gets the attribute value for the calculated attribute TransBooksWorkOrderNo.
     * @return the TransBooksWorkOrderNo
     */
    public Integer getTransBooksWorkOrderNo() 
    {
        try 
        {
            if (getAttributeInternal(TRANSBOOKSWORKORDERNO) == null && getHeaderId() != null) {
        ...
        return (Integer) getAttributeInternal(TRANSBOOKSWORKORDERNO);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute TransBooksWorkOrderNo.
     * @param value value to set the  TransBooksWorkOrderNo
     */
    public void setTransBooksWorkOrderNo(Integer value) {
        setAttributeInternal(TRANSBOOKSWORKORDERNO, value);
    }

    /**
     * Gets the associated <code>RowIterator</code> using master-detail link SpecialQualificationsVO.
     */
    public RowIterator getSpecialQualificationsVO() {
        return (RowIterator) getAttributeInternal(SPECIALQUALIFICATIONSVO);
    }

    /**
     * Gets the view accessor <code>RowSet</code> PreviousBooksLOV1.
     */
    public RowSet getPreviousBooksLOV1() {
        return (RowSet) getAttributeInternal(PREVIOUSBOOKSLOV1);
    }
