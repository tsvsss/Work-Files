...
AS
   ...
   * 09-JUN-2020 IRI              1.49               VTONDAPU       09-JUN-2020  E Added  procedure insert_esr_user_master, insert_esr_user_cross_ref
                                                                               create_esr_corp_batch_vetting, query_esr_corp_cross_references
                                                                               insert_esr_corp_party_master, insert_esr_corp_cross_ref
   * 23-JUN-2020 IRI              1.59               SAGARWAL       23-JUN-2020  E  For Vessel Contacts Change TC Email Address
*******************************************************************************************************************************************************/
