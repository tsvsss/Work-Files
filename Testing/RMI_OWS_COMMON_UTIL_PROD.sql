...
AS
   ...
   * 09-JUN-2020 IRI              1.59               VTONDAPU       09-JUN-2020  E Added  procedure insert_esr_user_master, insert_esr_user_cross_ref create_esr_corp_batch_vetting, query_esr_corp_cross_references insert_esr_corp_party_master, insert_esr_corp_cross_ref
   * 23-JUN-2020 IRI              1.60               SAGARWAL       23-JUN-2020  E  For Vessel Contacts Change TC Email Address
   * 07-JUL-2020 IRI                 1.61               TSUAZO              07-JUL-2020 B  Fix where clause for alert mismatch              *
*******************************************************************************************************************************************************/
             ...
             --xwrl_ows_utils.changetoowsstate(p_alert_in_tbl (i).p_to_state);
                  ...
                  apps.mt_log_error (  'Update xwrl_response_ind_columns ');
                     ...
                     --WHERE ID = r_ind_cols.ID AND listid = l_listid;   -- tsuazo 20200515 Alert can have multiple response  records
                      ...
                      WHERE  listid = l_listid  and exists  (select 1 from xwrl_requests x where x.id = request_id  and x.batch_id = l_batch_id); -- tsuazo 20200714 Alert can have multiple response  records
...
\*                             AND alias_id IS NULL
      ...
      LOOP
         ...
         LOOP
            ...
            l_notes_rec.case_id      := r_alias_rec.case_id;
            l_notes_rec.request_id   := r_alias_rec.ID;
            l_notes_rec.orig_note_id := r_primary_rec.ID;
...
END update_alert_status_gender;*/
   ...
   IS
      ...
      --- Modified By Gopi Vella as City field is no longer being used in XWRL_REUQESTS table.
