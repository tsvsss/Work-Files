...
BEGIN
  ...
  -- 1st record
    ...
    p_alert_in_tbl(1).comment := 'Name is common with multiple false positives, Seafarer was at sea at the time the person listed was serving prison sentence per WC article -- AWITTIG';
