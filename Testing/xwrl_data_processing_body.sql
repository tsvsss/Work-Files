...
* 23-APR-2019 IRI              1.3                TSUAZO          23-APR-2019  E      Disable migration procedures and functions *
*                                                                                                                   *
********************************************************************************************************************/
...
--and c.WC_SCREENING_REQUEST_ID = 848005
   ...
   for c1rec in c1 (v_max_jobs) loop
         ...
         dbms_scheduler.create_job (job_name => v_job_name, job_class => v_job_class, program_name => v_program_name, start_date => SYSDATE, end_date => NULL, enabled => false, comments => 'Oracle OWS Batch Vetting');
