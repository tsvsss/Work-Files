...
FUNCTION get_case_state (p_status IN xwrl_parameters.KEY%TYPE) RETURN VARCHAR2;

FUNCTION get_case_status (p_status IN xwrl_parameters.KEY%TYPE) RETURN VARCHAR2;

FUNCTION get_case_workflow (p_status IN xwrl_parameters.KEY%TYPE) RETURN VARCHAR2;

FUNCTION get_office(p_code IN vssl_offices.code%TYPE) RETURN VARCHAR2;

FUNCTION contains_legal_review (p_path IN varchar2, p_request_id IN number) return varchar2;
   ...
   FUNCTION is_maintenance_window (p_date date) RETURN boolean;
