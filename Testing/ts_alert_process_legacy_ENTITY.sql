...
from xwrl_response_entity_columns ind
,req
...
and r.alias_id is null
and r.xref_id is null)
select ind.request_id,  ind.alertid,  ind.x_state, ind.rec, ind.listrecordtype, ind.listid,req.name_screened,ind.listnametype, ind.listprimaryname, req.master_id, req.alias_id, req.xref_id
--,req.date_of_birth
