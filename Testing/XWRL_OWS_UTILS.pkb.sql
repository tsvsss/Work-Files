...
--         END IF;
      ...
      */
      ...
      IF l_alert_in_tbl.COUNT > 0 THEN
      ...
      LOOP
         ...
         SELECT source_table, source_id, PATH , master_id, alias_id, xref_id
           INTO v_source_table, v_source_id, v_path, v_master_id, v_alias_id, v_xref_id
         ...
         THEN
            ...
            THEN
               UPDATE xwrl_response_ind_columns
                ...
                WHERE request_id = p_request_id AND listid = v_list_id;
