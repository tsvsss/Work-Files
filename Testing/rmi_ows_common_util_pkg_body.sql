...
* 16-JAN-2020 IRI              1.34               TSUAZO   16-JAN-2020 B Update sync_matches for Individual to move code to match Entity
********************************************************************************************************************************************/
...
--         l_residence_country_code := ows_ind.residencycountrycode;
         ...
         l_passport_issuing_country := get_country_code(ows_ind.addresscountrycode);
         l_citizenship_country_code := get_country_code(ows_ind.nationalitycountrycodes);
         l_residence_country_code   := get_country_code(ows_ind.residencycountrycode);
...
--      END;
      ...
      l_prev_batch_id := rmi_ows_common_util.get_prev_batch_id (p_source_table, p_source_id);
...
--                     );
         ...
         LOOP
            ...
            THEN
               ...
               LOOP
				  ...
				  -- tsuazo 1/16/2010 moved	code to here as is Entity							
                  -- UPDATE EBS ALERT STATE
   ...
   IS
      ...
      CURSOR cur_requests
      IS
         SELECT ID request_id, batch_id, master_id
           FROM xwrl_requests
...
--p_custom_id1:='NRMI Cert';                                             --     T20180103.0033  commented by SHIVI dated: 26062018
   ...
   BEGIN
      ...
      l_alert_in_tbl (1).to_state := p_alert_state;
      l_alert_in_tbl (1).COMMENT := 'Marking as False Positive Becuase of Gender Mismatch';
   ...
   BEGIN
      ...
      t_country := t_countryarray (p_country_of_address,p_country_of_residence,p_country_of_nationality,p_country_of_birth,p_country_of_registration);
