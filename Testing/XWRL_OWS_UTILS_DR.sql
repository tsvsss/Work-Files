         ...
         LOOP
            ...
            THEN
               ...
               INSERT INTO xwrl_alert_notes
                    ...
                    VALUES (v_id, p_request_id,
                            l_alert_out_tbl (i).alert_id, v_line_number,
               ...
               BEGIN
                  INSERT INTO xwrl_note_xref
                              (ID, note_id, request_id,
                               alert_id, line_number,
                               case_key, master_id, alias_id,
                               xref_id, source_table, source_table_column,
                               source_id, list_id,
                               from_state,
                               to_state,
                               enabled_flag, status, record_comment,
               ...
               THEN
                  ...
                  WHERE  request_id = p_request_id
                     AND alertid = l_alert_out_tbl (i).alert_id;
            ...
            */
            ...
            THEN
               ...
               INSERT INTO xwrl_alert_notes
                    ...
                    VALUES (v_id,
                            p_request_id, l_alert_out_tbl (i).alert_id,
                            v_line_number, l_alert_in_tbl (i).COMMENT,
                                                                     --v_note,
                            SYSDATE, p_user_id,
                            SYSDATE, p_user_id, p_session_id
                           );
               ...
               BEGIN
                  INSERT INTO xwrl_note_xref
                       ...
                       VALUES (NULL,                         -- ID                  ,
                               ...
                               'Y',                          --ENABLED_FLAG        ,
                               'N',                          --STATUS              , add N as New for now
                               'From Process Alert 2',       --RECORD_COMMENT      ,
                               SYSDATE, 
                               p_user_id,
                               SYSDATE, 
                               p_user_id, 
