...
// ---    Mon Jul 01 13:50:01 EDT 2019
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class XwrlCaseDocumentsImpl extends EntityImpl {
    /**
    ...
    private static ADFLogger LOGGER = ADFLogger.createADFLogger(XwrlCaseDocumentsImpl.class);
    ...
    public static final int XWRLREQUESTS2 = AttributesEnum.XwrlRequests2.index();

    /**
     * This is the default constructor (do not remove).
     */
    public XwrlCaseDocumentsImpl() {
    }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("oracle.apps.xwrl.model.entity.XwrlCaseDocuments");
    }
     ...
     * @return the associated entity oracle.jbo.server.EntityImpl.
     */
    public EntityImpl getXwrlRequests2() {
        return (EntityImpl) getAttributeInternal(XWRLREQUESTS2);
    }

    /**
     * Sets <code>value</code> as the associated entity oracle.jbo.server.EntityImpl.
     */
    public void setXwrlRequests2(EntityImpl value) {
        setAttributeInternal(XWRLREQUESTS2, value);
    }
    ...
    protected void create(AttributeList attributeList) {
        ...
        id = nextVal("XWRL_CASE_DOCUMENTS_SEQ").bigDecimalValue();
