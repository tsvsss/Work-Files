...
public class ADFUtils {
    ...
    public static AttributeBinding findControlBinding(BindingContainer bindingContainer, String attributeName) {
        try {
            ...
            e.printStackTrace();
            JSFUtils.addFormattedFacesErrorMessage("System encountered an exception while performing this task." +
     ...
     */
    public static List<String> attributeListForIterator(String iteratorName, String valueAttrName) {
     ...
     */
    public static List<String> attributeListForIterator(DCIteratorBinding iter, String valueAttrName) {
        List<String> attributeList = new ArrayList<String>();
        for (Row r : iter.getAllRowsInRange()) {
            attributeList.add((String)r.getAttribute(valueAttrName));
        }
        return attributeList;
    }
     ...
     * @param opList
     */
    public static void printOperationBindingExceptions(List<String> opList) {
