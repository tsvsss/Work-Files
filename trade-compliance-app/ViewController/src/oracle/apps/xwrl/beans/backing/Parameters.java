...
public class Parameters 
{
    ...
    public void paramReturnListener(ReturnEvent evt) 
    {
        ...
        try {
            ...
            dciter = (DCIteratorBinding) bindings.get("XwrlParametersView1Iterator");
            dciter.executeQuery();
    ...
    public void add() 
          {
              ...
              Row newRow = null;
               ...
               try 
               {
                  ...
                  {
                      utils.displayErrorMessage("Error adding Parameters info: "+e);
                  }
    ...
    public void search() 
           {
               ...
               try 
               {
                   ps = (RichPanelSplitter) JSFUtils.findComponentInRoot("schprm");
       ...
       public void reset() 
       {
           ...
           try 
           {
               ...
               utils.resetSort(table,"XwrlParametersView1Iterator");
               
               utils.resetTableFilterAction(table);
       
               // Refresh view XwrlParametersView1Iterator
               utils.refreshTable("XwrlParametersView1Iterator","t1");
    ...
    public void resetSort()
           {
               ...
               try 
               {
                   ...
                   DCIteratorBinding iterBind = (DCIteratorBinding) dcBindings.get("XwrlParametersView1Iterator");
                   Key currentRow = null;
    ...
    public void save() 
        {
            ...
            {
                utils.displayErrorMessage("Error Saving Parameters: "+e); 
            }
        }
