package com.rmi.applicationEntry.view.batchesabntaskflow;
...
public class BatchesPendingAbnBean {
    public BatchesPendingAbnBean() {
    }
    ...
    public void assignBatch(ActionEvent actionEvent) {
        ...
        try {
            OperationBinding ob = getBindings().getOperationBinding("assignTaskToUserABN");
