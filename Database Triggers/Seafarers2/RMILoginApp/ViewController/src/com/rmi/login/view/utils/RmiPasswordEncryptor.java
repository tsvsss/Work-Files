...
public class RmiPasswordEncryptor {
    
    public RmiPasswordEncryptor() {
        super();
    }
    ...
    public static String Encrypt(String password)
    {
        try 
        {
            ...
            RmiJsfUtils.addFormattedFacesErrorMessage("System encountered an exception while Encrypting password. Please contact your System Administrator. !",
    ...
    public static String Decrypt(String password)
    {
        try 
        {
            ...
            RmiJsfUtils.addFormattedFacesErrorMessage("System encountered an exception while Decrypting password. Please contact your System Administrator. !",
                                                      "", FacesMessage.SEVERITY_ERROR);
        }
