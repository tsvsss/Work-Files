...
import com.rmi.login.adfbc.services.RmiLoginAppModuleImpl;
...
public class RmiAdfUtils {
    public RmiAdfUtils() {
        super();
    }
    public static final ADFLogger LOGGER = ADFLogger.createADFLogger(RmiAdfUtils.class);
    ...
    public static ApplicationModule getApplicationModuleForDataControl(String name) {
        return (ApplicationModule) RmiJsfUtils.resolveExpression("#{data." + name + ".dataProvider}");
    }
    ...
    public static BindingContainer getBindingContainer() {
        return (BindingContainer) RmiJsfUtils.resolveExpression("#{bindings}");
    }
    ...
    public static DCIteratorBinding findIterator(String bindingContainer, String iterator) {
        DCBindingContainer bindings = (DCBindingContainer) RmiJsfUtils.resolveExpression("#{" + bindingContainer + "}");
        if (bindings == null) {
    ...
    public static OperationBinding findOperation(String bindingContianer, String opName) {
        DCBindingContainer bindings = (DCBindingContainer) RmiJsfUtils.resolveExpression("#{" + bindingContianer + "}");
        if (bindings == null) {
     ...
     **/
    public static void printTmpLogs(Object logDesc)
    {
        Connection con = null;
        ...
        try 
        {
            if(logDesc != null)
            {
                ...
                try {
                    dbTransaction = (DBTransaction) getAm().getTransaction();
    ...
    public static RmiLoginAppModuleImpl getAm()
    {
        RmiLoginAppModuleImpl am;
        am = (RmiLoginAppModuleImpl) getApplicationModuleForDataControl("RmiLoginAppModuleDataControl");
        return am;
    }
