...
public class RmiSeafarerDocsSqcViewRowImpl extends ViewRowImpl {
    ...
    public static final int DOCLIMITATIONUPDSQC = AttributesEnum.DocLimitationUpdSqc.index();
    public static final int LINEPROCESSEDSQC = AttributesEnum.LineProcessedSqc.index();
    ...
    {        
        System.out.println("SQC CocCountry setter :: "+value);
    ...
    public String getIssueType1()
    {
        try 
        {
//            if(gettranGradeCodeSqc() != null && gettranGradeCodeSqc().equalsIgnoreCase("TOS"))
//            {
//                System.out.println("SQC issue type getter :: "+getAttributeInternal(ISSUETYPE1)
//                                   +" for Grade :: "+gettranGradeCodeSqc());
//            }
    ...
    {
        System.out.println("SQC issue type setter :: "+value);
...
//        }
    ...
    /**
     * Gets the attribute value for DOC_LIMITATION_UPD using the alias name DocLimitationUpdSqc.
     * @return the DOC_LIMITATION_UPD
     */
    public String getDocLimitationUpdSqc() {
        return (String) getAttributeInternal(DOCLIMITATIONUPDSQC);
    }

    /**
     * Sets <code>value</code> as attribute value for DOC_LIMITATION_UPD using the alias name DocLimitationUpdSqc.
     * @param value value to set the DOC_LIMITATION_UPD
     */
    public void setDocLimitationUpdSqc(String value) {
        setAttributeInternal(DOCLIMITATIONUPDSQC, value);
    }

    /**
     * Gets the attribute value for LINE_PROCESSED using the alias name LineProcessedSqc.
     * @return the LINE_PROCESSED
     */
    public String getLineProcessedSqc() {
        return (String) getAttributeInternal(LINEPROCESSEDSQC);
    }

    /**
     * Sets <code>value</code> as attribute value for LINE_PROCESSED using the alias name LineProcessedSqc.
     * @param value value to set the LINE_PROCESSED
     */
    public void setLineProcessedSqc(String value) {
        setAttributeInternal(LINEPROCESSEDSQC, value);
    }
