...
// ---    Wed Nov 28 13:09:06 IST 2018
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class SpecialQualificationsViewRowImpl extends ViewRowImpl {
    ...
    public enum AttributesEnum {
        ...
        TransSQCWorkOrderNo,
        TransSqcAllGrades,
        SqcDetailsCapacitiesVO,
        SqcDetailsFunctionsVO,
        PreviousSQCLOV1,
        StatusLOV1,
        IssueTypeLOV1,
        viewGradeSqcLOV1,
        ...
        public int index() {
            return SpecialQualificationsViewRowImpl.AttributesEnum.firstIndex() + ordinal();
        }
        ...
        public static int count() {
            return SpecialQualificationsViewRowImpl.AttributesEnum.firstIndex() +
                   SpecialQualificationsViewRowImpl.AttributesEnum.staticValues().length;
        }

        public static final AttributesEnum[] staticValues() {
            if (vals == null) {
                vals = SpecialQualificationsViewRowImpl.AttributesEnum.values();
            }
            return vals;
        }
    }
    ...
    public static final int TRANSGRADESQC = AttributesEnum.TransGradeSqc.index();
    public static final int TRANSENDORSCNTRY = AttributesEnum.TransEndorsCntry.index();
    public static final int TRANSSQCWORKORDERNO = AttributesEnum.TransSQCWorkOrderNo.index();
    public static final int TRANSSQCALLGRADES = AttributesEnum.TransSqcAllGrades.index();
    public static final int SQCDETAILSCAPACITIESVO = AttributesEnum.SqcDetailsCapacitiesVO.index();
    public static final int SQCDETAILSFUNCTIONSVO = AttributesEnum.SqcDetailsFunctionsVO.index();
    public static final int PREVIOUSSQCLOV1 = AttributesEnum.PreviousSQCLOV1.index();
     ...
     */
    public SpecialQualificationsViewRowImpl() {
    }
    ...
    {
        if(getAttributeInternal(DOCUMENTTYPE) != null)
    ...
    public void setEndorsementNumber(String value) 
    {
        if(value != null && value.trim().length()> 0)
            setAttributeInternal(ENDORSEMENTNUMBER, value.toUpperCase());
        else
...
//        }
    ...
    {
//        if(value != null && value.equalsIgnoreCase("VOID"))
//        {
//            setAttributeInternal(DOCUMENTPREVIOUSID, null);
//            setAttributeInternal(TRANSPREVIOUSSQC, null);
//        }
    ...
    public Integer getTransPreviousSQC() 
    {
        try 
        {
            if (getAttributeInternal(TRANSPREVIOUSSQC) == null && getDocumentPreviousId() != null) {
                ViewObjectImpl prvsSqcVo = getAm().getPreviousSicdSQCView1();
                prvsSqcVo.setNamedWhereClauseParam("pDocumentId", getDocumentId());
                prvsSqcVo.setNamedWhereClauseParam("pSeafarerId", getSeafarerId());
                prvsSqcVo.executeQuery();

                Row[] frRows = prvsSqcVo.getFilteredRows("DocumentId", getDocumentPreviousId());

                if (frRows.length > 0 && frRows[0].getAttribute("SqcNumber") != null) {
                    return Integer.parseInt(frRows[0].getAttribute("SqcNumber").toString());
                }
            }
        } catch (Exception nfe) {
            AdfUtils.addFormattedFacesErrorMessage("System encountered an exception while fetching data." +
    ...
    /**
     * Gets the attribute value for the calculated attribute TransGradeSqc.
     * @return the TransGradeSqc
     */
    public String getTransGradeSqc() 
    {
        try 
        {
            if (getAttributeInternal(TRANSGRADESQC) == null && getGradeId() != null) {
                ViewObjectImpl gradeVo = getAm().getGradeSqcView1();
        ...
        return (String) getAttributeInternal(TRANSGRADESQC);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute TransGradeSqc.
     * @param value value to set the  TransGradeSqc
     */
    public void setTransGradeSqc(String value) {
        setAttributeInternal(TRANSGRADESQC, value);
    }

    /**
     * Gets the attribute value for the calculated attribute TransEndorsCntry.
     * @return the TransEndorsCntry
     */
    public String getTransEndorsCntry() 
    {
        try 
        {
            if (getAttributeInternal(TRANSENDORSCNTRY) == null && getEndorsementCountry() != null) {
        ...
        return (String) getAttributeInternal(TRANSENDORSCNTRY);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute TransEndorsCntry.
     * @param value value to set the  TransEndorsCntry
     */
    public void setTransEndorsCntry(String value) {
        setAttributeInternal(TRANSENDORSCNTRY, value);
    }

    /**
     * Gets the attribute value for the calculated attribute TransSQCWorkOrderNo.
     * @return the TransSQCWorkOrderNo
     */
    public Integer getTransSQCWorkOrderNo() 
    {
        try 
        {
            if (getAttributeInternal(TRANSSQCWORKORDERNO) == null && getHeaderId() != null) {
        ...
        return (Integer) getAttributeInternal(TRANSSQCWORKORDERNO);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute TransSQCWorkOrderNo.
     * @param value value to set the  TransSQCWorkOrderNo
     */
    public void setTransSQCWorkOrderNo(Integer value) {
        setAttributeInternal(TRANSSQCWORKORDERNO, value);
    }

    /**
     * Gets the attribute value for the calculated attribute TransSqcAllGrades.
     * @return the TransSqcAllGrades
     */
    public String getTransSqcAllGrades()
    {
        if(getAttributeInternal(TRANSSQCALLGRADES) == null && getGradeId() != null)
        {
            try 
            {
                ...
                AdfUtils.addFormattedFacesErrorMessage("System encountered an exception while fetching SQC Grade." +
                                                 " Please contact your System Administrator." , 
                                                 "", FacesMessage.SEVERITY_ERROR); 
            }
        }
        return (String) getAttributeInternal(TRANSSQCALLGRADES);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute TransSqcAllGrades.
     * @param value value to set the  TransSqcAllGrades
     */
    public void setTransSqcAllGrades(String value) {
        setAttributeInternal(TRANSSQCALLGRADES, value);
    }

    /**
     * Gets the associated <code>RowIterator</code> using master-detail link SqcDetailsCapacitiesVO.
     */
    public RowIterator getSqcDetailsCapacitiesVO() {
        return (RowIterator) getAttributeInternal(SQCDETAILSCAPACITIESVO);
    }

    /**
     * Gets the associated <code>RowIterator</code> using master-detail link SqcDetailsFunctionsVO.
     */
    public RowIterator getSqcDetailsFunctionsVO() {
        return (RowIterator) getAttributeInternal(SQCDETAILSFUNCTIONSVO);
    }

    /**
     * Gets the view accessor <code>RowSet</code> PreviousSQCLOV1.
     */
    public RowSet getPreviousSQCLOV1() {
        return (RowSet) getAttributeInternal(PREVIOUSSQCLOV1);
    }
