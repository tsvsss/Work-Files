package com.rmi.tradecompapproval.adfbc.utils;
...
public class AdfUtils {
     ...
     **/
    public static Object callDbFunction(ApplicationModuleImpl am, int sqlReturnType, String stmt, Object[] bindVars) {
