...
// ---    Thu Nov 29 16:57:04 IST 2018
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class OcDetailsCapacitiesViewRowImpl extends ViewRowImpl {
    ...
    public enum AttributesEnum {
        ...
        OcDetailsCapacitiesLovView1;
        static AttributesEnum[] vals = null;
        ;
        private static final int firstIndex = 0;

        public int index() {
            return OcDetailsCapacitiesViewRowImpl.AttributesEnum.firstIndex() + ordinal();
        }
        ...
        public static int count() {
            return OcDetailsCapacitiesViewRowImpl.AttributesEnum.firstIndex() +
                   OcDetailsCapacitiesViewRowImpl.AttributesEnum.staticValues().length;
        }

        public static final AttributesEnum[] staticValues() {
            if (vals == null) {
                vals = OcDetailsCapacitiesViewRowImpl.AttributesEnum.values();
            }
            return vals;
        }
    }
    ...
    public static final int TRANSCAPACITYDESC = AttributesEnum.TransCapacityDesc.index();
    public static final int TRANSLIMITATIONDESC = AttributesEnum.TransLimitationDesc.index();
    public static final int OCDETAILSLIMITATIONSLOV1 = AttributesEnum.OcDetailsLimitationsLOV1.index();
    public static final int OCDETAILSCAPACITIESLOVVIEW1 = AttributesEnum.OcDetailsCapacitiesLovView1.index();

    /**
     * This is the default constructor (do not remove).
     */
    public OcDetailsCapacitiesViewRowImpl() {
    }
    ...
    /**
     * Gets the attribute value for the calculated attribute TransCapacityDesc.
     * @return the TransCapacityDesc
     */
    public String getTransCapacityDesc() 
    {
        try 
        {
            if (getAttributeInternal(TRANSCAPACITYDESC) == null && getPositionId() != null) {
                ViewObjectImpl capVo = getAm().getOcDetailsCapacitiesLovView1();
        ...
        return (String) getAttributeInternal(TRANSCAPACITYDESC);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute TransCapacityDesc.
     * @param value value to set the  TransCapacityDesc
     */
    public void setTransCapacityDesc(String value) {
        setAttributeInternal(TRANSCAPACITYDESC, value);
    }

    /**
     * Gets the attribute value for the calculated attribute TransLimitationDesc.
     * @return the TransLimitationDesc
     */
    public String getTransLimitationDesc() 
    {
//        try 
//        {
//            if (getAttributeInternal(TRANSLIMITATIONDESC) == null && getLimitations() != null) {
...
//                                             "", FacesMessage.SEVERITY_ERROR); 
//        }
        return (String) getAttributeInternal(TRANSLIMITATIONDESC);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute TransLimitationDesc.
     * @param value value to set the  TransLimitationDesc
     */
    public void setTransLimitationDesc(String value) {
        setAttributeInternal(TRANSLIMITATIONDESC, value);
    }
    ...
    /**
     * Gets the view accessor <code>RowSet</code> OcDetailsCapacitiesLovView1.
     */
    public RowSet getOcDetailsCapacitiesLovView1() {
        return (RowSet) getAttributeInternal(OCDETAILSCAPACITIESLOVVIEW1);
    }
