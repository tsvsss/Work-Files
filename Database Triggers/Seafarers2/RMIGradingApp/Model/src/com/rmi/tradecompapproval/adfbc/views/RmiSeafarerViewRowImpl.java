...
public class RmiSeafarerViewRowImpl extends ViewRowImpl {
    ...
    public static final int TRANSSAVELINEOC = AttributesEnum.TransSaveLineOc.index();
    public static final int TRANSSAVELINESQC = AttributesEnum.TransSaveLineSqc.index();
    ...
    public String gettranCity() {
        try 
        {
            ...
            if (getWcCityListId() != null) 
            {
                ...
                Row[] fr = cityRO.getAllRowsInRange();
                if (fr.length > 0 && fr[0].getAttribute("CityName") != null) {
                    return fr[0].getAttribute("CityName").toString();
                }
                return CityName;
            }
        } catch (Exception e) {
...
//                                             "", FacesMessage.SEVERITY_ERROR); 
        ...
        try {
            if (getAttributeInternal(TRANSBATCHSTATUS) == null) {
                ...
                if (batchRow != null && batchRow.getAttribute("BatchStatus") != null 
                     && (getApplicationCorrectedFlag() != null && getApplicationCorrectedFlag().equalsIgnoreCase("Y"))
                     && (getSeafarerWfStatus()!= null && (getSeafarerWfStatus().equalsIgnoreCase("Pending_VAL")
                                                         || getSeafarerWfStatus().equalsIgnoreCase("Pending_QA"))))
                {
    ...
    public String getTransOcCorrected()
    {
        try 
        {
            ...
            return ((ocRows.length > 0) && (getApplicationCorrectedFlag() != null 
                                            && getApplicationCorrectedFlag().equalsIgnoreCase("Y"))) ? "Y" : "N";
        } catch (Exception e) {
            e.printStackTrace();
...
//            System.out.println(getBookGrdStatus().toString()+"--------book status");
            ...
            return ((sqcRows.length > 0) && (getApplicationCorrectedFlag() != null 
                                            && getApplicationCorrectedFlag().equalsIgnoreCase("Y"))) ? "Y" : "N";
        } catch (Exception e) {
            e.printStackTrace();
...
//                vwSfrrRow.setAttribute("TransColorCode", "");
    ...
    {
        if(getApplicationCorrectedFlag() != null && getApplicationCorrectedFlag().equalsIgnoreCase("Y"))
        {
            ...
            if (getIdentityDocVerified() != null) 
            {           
                if (getIdentityDocVerified().equalsIgnoreCase("No")) {
                    return "Y";
                }
            }
            ...
            if (getApplicationVerified() != null) 
            {          
    ...
    /**
     * Gets the attribute value for the calculated attribute TransSaveLineOc.
     * @return the TransSaveLineOc
     */
    public String getTransSaveLineOc() 
    {
        try 
        {
            ViewObjectImpl ocVo = getAm().getRmiSeafarerDocsOcView1();
            Row[] ocRows = ocVo.getFilteredRows("LineProcessedOc", "N");
            System.out.println("LineProcessedOc ocRows.length :: "+ocRows.length);
            return (ocRows.length > 0) ? "Y" : "N";
        } catch (Exception e) {
            e.printStackTrace();
            AdfUtils.addFormattedFacesErrorMessage("System encountered an exception while fetching count of pending OC lines to be saved." +
                                             " Please contact your System Administrator." , 
                                             "", FacesMessage.SEVERITY_ERROR); 
        }
        return (String) getAttributeInternal(TRANSSAVELINEOC);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute TransSaveLineOc.
     * @param value value to set the  TransSaveLineOc
     */
    public void setTransSaveLineOc(String value) {
        setAttributeInternal(TRANSSAVELINEOC, value);
    }

    /**
     * Gets the attribute value for the calculated attribute TransSaveLineSqc.
     * @return the TransSaveLineSqc
     */
    public String getTransSaveLineSqc() 
    {
        try 
        {
            ViewObjectImpl sqcVo = getAm().getRmiSeafarerDocsSqcView1();
            Row[] sqcRows = sqcVo.getFilteredRows("LineProcessedSqc", "N");
            System.out.println("LineProcessedSqc sqcRows.length :: "+sqcRows.length);
            return (sqcRows.length > 0) ? "Y" : "N";
        } catch (Exception e) {
            e.printStackTrace();
            AdfUtils.addFormattedFacesErrorMessage("System encountered an exception while fetching count of pending SQC lines to be saved." +
                                             " Please contact your System Administrator." , 
                                             "", FacesMessage.SEVERITY_ERROR); 
        }
        return (String) getAttributeInternal(TRANSSAVELINESQC);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute TransSaveLineSqc.
     * @param value value to set the  TransSaveLineSqc
     */
    public void setTransSaveLineSqc(String value) {
        setAttributeInternal(TRANSSAVELINESQC, value);
    }
    ...
    /**
     * Gets the attribute value for APPLICATION_CORRECTED_FLAG using the alias name ApplicationCorrectedFlag.
     * @return the APPLICATION_CORRECTED_FLAG
     */
    ...
    /**
     * Sets <code>value</code> as attribute value for APPLICATION_CORRECTED_FLAG using the alias name ApplicationCorrectedFlag.
     * @param value value to set the APPLICATION_CORRECTED_FLAG
     */
