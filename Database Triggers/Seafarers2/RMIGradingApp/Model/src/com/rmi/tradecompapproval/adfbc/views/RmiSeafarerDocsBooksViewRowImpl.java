...
// ---    Fri Apr 12 15:12:45 IST 2019
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class RmiSeafarerDocsBooksViewRowImpl extends ViewRowImpl {
    ...
    public enum AttributesEnum {
        ...
        public int index() {
            return RmiSeafarerDocsBooksViewRowImpl.AttributesEnum.firstIndex() + ordinal();
        }
        ...
        public static int count() {
            return RmiSeafarerDocsBooksViewRowImpl.AttributesEnum.firstIndex() +
                   RmiSeafarerDocsBooksViewRowImpl.AttributesEnum.staticValues().length;
        }

        public static final AttributesEnum[] staticValues() {
            if (vals == null) {
                vals = RmiSeafarerDocsBooksViewRowImpl.AttributesEnum.values();
            }
            return vals;
        }
    }
    ...
    public static final int DATAVERIFIED2 = AttributesEnum.DataVerified2.index();
    public static final int YESNOLOV1 = AttributesEnum.YesNoLOV1.index();

    /**
     * This is the default constructor (do not remove).
     */
    public RmiSeafarerDocsBooksViewRowImpl() {
    }
    ...
    public void setCocCountry(String value) {
        ...
        System.out.println("BOOK CocCountry setter :: "+value);
...
//        setAttributeInternal(COCCOUNTRY, value);
     ...
     */
    public String getDataVerified2()
    {
        try 
        {
            if (getAttributeInternal(DATAVERIFIED2) != null)
                return (String) getAttributeInternal(DATAVERIFIED2);
            else
                return "No";
        } catch (Exception e) {
     ...
     */
    public void setDataVerified2(String value) {
        setAttributeInternal(DATAVERIFIED2, value);
    }
