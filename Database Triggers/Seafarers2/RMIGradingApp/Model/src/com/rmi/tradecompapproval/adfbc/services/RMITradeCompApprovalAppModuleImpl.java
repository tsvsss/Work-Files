...
public class RMITradeCompApprovalAppModuleImpl extends ApplicationModuleImpl implements RMITradeCompApprovalAppModule{
    ...
    public void editBatch(Integer batch_id)
    {
         try 
         {
            ...
            AdfFacesContext.getCurrentInstance().getPageFlowScope().put("CURRENT_ESI_BATCH_ID", batch_id);
...
//                    vwSfrrVo.setNamedWhereClauseParam("pEsiBatchId", batchRow.getAttribute("EsiBatchId"));
                    ...
                    vwSfrrVo.setNamedWhereClauseParam("pEsiBatchId", ADFContext.getCurrent().getPageFlowScope().get("CURRENT_ESI_BATCH_ID"));
            ...
            if (vwSfrrRow != null && vwSfrrRow.getAttribute("SeafarerId") != null) {
                ...
                if (filterType != null) {
                    if (filterType.equalsIgnoreCase("a")) {
                        ...
                        ViewObjectImpl ocWaitngVO = this.getOcWaitingResponseView1();
                        ocWaitngVO.setNamedWhereClauseParam("pSalesRepId", getUserId());
                        ocWaitngVO.setNamedWhereClauseParam("pSeafarerId", seafarerId);
                        ocWaitngVO.executeQuery();
                    }
                }
        ...
        try 
        {
            ...
            if (dualEoRow != null) 
            {
                if(dualEoRow.getAttribute("TransBatchName") != null 
                    && dualEoRow.getAttribute("TransBatchName").toString().length()> 0)
                {
                    System.out.println("TransBatchName :: "+dualEoRow.getAttribute("TransBatchName"));                    
                        
                    ViewObjectImpl batchVo = this.getRmiBatchView3();
                    batchVo.setNamedWhereClauseParam("pBatchName", dualEoRow.getAttribute("TransBatchName").toString().trim());
                ...
                if(batchRowsCount.equalsIgnoreCase("Y"))
                {
                    ...
                    if (eoHdrVo.getAllRowsInRange().length > 0 && eoHdrVo.getAllRowsInRange()[0] != null) {
                        ...
                        if(batchRows.length > 0 && batchRows[0].getAttribute("BatchName") != null)
                        {
                            ...
                            dualEoRow.setAttribute("TransBatchNotes", batchRows[0].getAttribute("Notes"));
                            dualEoRow.setAttribute("TransBatchVesselName", batchRows[0].getAttribute("VesselNames"));
                            dualEoRow.setAttribute("TransInvoiceEmailId", batchRows[0].getAttribute("InvoiceAgentEmailId"));
                            dualEoRow.setAttribute("TransEsiBatchId", batchRows[0].getAttribute("EsiBatchId"));
                            ADFContext.getCurrent().getPageFlowScope().put("P_BATCH_NAME", batchRows[0].getAttribute("BatchName"));
                            ADFContext.getCurrent().getPageFlowScope().put("P_BATCH_NOTES", batchRows[0].getAttribute("Notes"));
                            ADFContext.getCurrent().getPageFlowScope().put("P_VESSEL_NAME", batchRows[0].getAttribute("VesselNames"));
                            ADFContext.getCurrent().getPageFlowScope().put("P_INVOICE_EMAIL", batchRows[0].getAttribute("InvoiceAgentEmailId"));
                            
                            ViewObjectImpl agentEmailVo = this.getRmiBatchDetailsView1();
                            agentEmailVo.setNamedWhereClauseParam("pEsiBatchId", batchRows[0].getAttribute("EsiBatchId"));
                            agentEmailVo.executeQuery();            
                            
                            Row[] agentEmailRows = agentEmailVo.getAllRowsInRange(); 
                            
//                            System.out.println("EsiBatchId :: "+batchRows[0].getAttribute("EsiBatchId"));            
//                            System.out.println("agentEmailRows.length :: "+agentEmailRows.length);                       
                            
                            if(agentEmailRows.length > 0 && agentEmailRows[0].getAttribute("OrderingAgentEmailId") != null)
                            {
//                                System.out.println("OrderingAgentEmailId :: "+agentEmailRows[0].getAttribute("OrderingAgentEmailId"));
                                dualEoRow.setAttribute("TransAgentEmailId", agentEmailRows[0].getAttribute("OrderingAgentEmailId"));
                                ADFContext.getCurrent().getPageFlowScope().put("P_AGENT_EMAIL", agentEmailRows[0].getAttribute("OrderingAgentEmailId"));
                            }                            
                        }                        
...
//            ADFContext.getCurrent().getSessionScope().put("P_BATCH_NAME", null);
            ...
            ADFContext.getCurrent().getPageFlowScope().put("P_BATCH_NOTES", null);
            ADFContext.getCurrent().getPageFlowScope().put("P_VESSEL_NAME", null);
            ADFContext.getCurrent().getPageFlowScope().put("P_INVOICE_EMAIL", null);
            ADFContext.getCurrent().getPageFlowScope().put("P_AGENT_EMAIL", null);
...
//                this.getDBTransaction().commit();
                ...
                retVal = (String) callDbFunction(Types.VARCHAR, "RMI_SICD_PUB.send_oc_for_verification(?,?,?)", new Object[] {
                    ...
                    {
                        if(sfrrDocOcRow != null)
                        {
                            sfrrDocOcRow.setAttribute("GradingStatus", "Pending");
                            sfrrDocOcRow.setAttribute("DocumentApprovedDate", null);
                            sfrrDocOcRow.setAttribute("DocumentApprovedBy", null);
                        }
                        
                        if(sfrrRow != null)
                        {
                            sfrrRow.setAttribute("SeafarerGrdStatus", "Pending");
                            sfrrRow.setAttribute("SeafarerApprovedDate", null);
                            sfrrRow.setAttribute("SeafarerApprovedBy", null);
                        }
                    }
...
//                        row.setAttribute("LastUpdatedRow", "N");
    ...
    public void cancelbatch()
    {
        try 
        {
            ...
            row.setAttribute("LastUpdatedBy", getUserId());
            //        this.getDBTransaction().commit();

            rejectBatch(row.getAttribute("EsiBatchId"));
            
            printTmpLogs("cancel_batch EsiBatchId :: "+row.getAttribute("EsiBatchId"));
            printTmpLogs("cancel_batch OeHeaderId :: "+row.getAttribute("OeHeaderId"));
            
            if(row.getAttribute("EsiBatchId") != null && row.getAttribute("OeHeaderId") != null)
            {
                String  retVal = (String) callDbFunction(Types.VARCHAR, "RMI_SICD_PUB.cancel_batch(?,?,?,?)", new Object[] {
                                                   row.getAttribute("EsiBatchId"), 
                                                   row.getAttribute("OeHeaderId"),
                                                   null, getUserId()
                  });
                
                printTmpLogs("cancel_batch retVal :: "+retVal);
                this.getDBTransaction().commit();
            }            
        } catch (Exception nfe) {
    ...
    public void addOcLine()
    {
        try 
        {
            ...
            createRow.setAttribute("LineProcessedOc", "N");
...
//                printTmpLogs("docsRsi.getRowCount :: "+docsRsi.getRowCount());
                
                
                Row[] unprocessedOcLines = this.getRmiSeafarerDocsOcView1().getFilteredRows("LineProcessedOc", "N");
                
                System.out.println("unprocessedOcLines.length :: "+unprocessedOcLines.length);
                
                for (Row r : unprocessedOcLines) {                    
                    
//                    Row r = docsRsi.next();
                    
                    if (r != null && r.getAttribute("EsdiId") != null) 
                    {
...
//                        Row[] fr = sfrrDocsVo.getFilteredRows("EsdiId", r.getAttribute("EsdiId"));
                        ...
                        printTmpLogs("r.getAttribute(EsdiId) :: "+r.getAttribute("EsdiId"));                        
//                        printTmpLogs("fr.length :: "+fr.length);
...
//                        }
                            ...
                            printTmpLogs("retVal for create_order_line :: "+retVal);
...
//                AdfFacesContext.getCurrentInstance().getPageFlowScope().put("Role_Name", "PROCESSOR - II"); //QA PROCESSOR-EVALUATOR
                ...
                Row[] batchRows = batchDtlVo.getAllRowsInRange();
                Row dualBookRow = (this.getDualProcessBookView1().getCurrentRow() != null)
                                    ? this.getDualProcessBookView1().getCurrentRow()
                                    : this.getDualProcessBookView1().first();
                
                if (dualBookRow != null && batchRows.length > 0 && batchRows[0].getAttribute("BatchName") != null) 
                {
                    dualBookRow.setAttribute("TransBatchNotes", batchRows[0].getAttribute("Notes"));
                    dualBookRow.setAttribute("TransVesselName", batchRows[0].getAttribute("VesselNames"));
                    dualBookRow.setAttribute("TransInvoiceEmailId", batchRows[0].getAttribute("InvoiceAgentEmailId"));
                    dualBookRow.setAttribute("TransEsiBatchId", batchRows[0].getAttribute("EsiBatchId"));
...
//                    System.out.println("agentEmailRows.length :: "+agentEmailRows.length);
                    ...
                    if (agentEmailRows.length > 0 &&
                        agentEmailRows[0].getAttribute("OrderingAgentEmailId") !=
                                                  null) {
                        //                                System.out.println("OrderingAgentEmailId :: "+agentEmailRows[0].getAttribute("OrderingAgentEmailId"));
                        dualBookRow.setAttribute("TransAgentEmailId",
                                               agentEmailRows[0].getAttribute("OrderingAgentEmailId"));
                    }
                }
            }
    ...
    public String assignBookNumbers()
    {
        ...
        try 
        {
            ...
            if (headerIdO != null && (dualBookRow != null && dualBookRow.getAttribute("Trans5Yr") != null)) {
                ...
                Row[] bookDtlRows = this.getProcessBookDetailsView1().getFilteredRows("TransSelectBook", "Y");
                
                System.out.println("bookDtlRows :: "+bookDtlRows.length);
                
                if(bookDtlRows.length <= 0)
                {
//                    AdfUtils.addFormattedFacesErrorMessage("Please select atleast 1 Book.", 
//                                                            "", FacesMessage.SEVERITY_ERROR);
                    return "NS";
                }
                
                int bookCounter = 0;
                int bookNumber = Integer.parseInt((dualBookRow.getAttribute("Trans5Yr")).toString());
                
                for(Row r : bookDtlRows)
                {                    
                    if(r != null && r.getAttribute("HeaderId") != null && r.getAttribute("LineId") != null)
                    {
                        printTmpLogs("HeaderId :: "+r.getAttribute("HeaderId"));
                        printTmpLogs("LineId :: "+r.getAttribute("LineId"));
                        printTmpLogs("bookNumber :: "+(bookNumber + bookCounter));
                        
                        try {
                            retVal = (String) callDbFunction(Types.VARCHAR, "RMI_SICD_PUB.rmi_assign_books(?,?,?,?,?)", new Object[] {
                                                             headerId,
                                                             bookNumber + bookCounter, null,
                                                             null,
                                                             ((r.getAttribute("LineId") != null)
            ...
            if (sicdSfrrRow != null) {
                ...
                if (sfrrRows.length> 0 && sfrrRows[0] != null) 
                {
                    ...
                    sqcRsi.closeRowSetIterator();
                                    ...
                                    printTmpLogs("identitydocPath =" + identitydocPath);
                                    printTmpLogs("medicalphysicaledocPath =" + medicalphysicaledocPath);
                                    printTmpLogs("serviceTransPath =" + serviceTransPath);
                                    printTmpLogs("applicationedocPath =" + applicationedocPath);
                                    printTmpLogs("affidavitPath =" + affidavitPath);
                                    printTmpLogs("securitysatedocPath =" + securitysatedocPath);
                                    printTmpLogs("consentdocPath =" + consentdocPath);
                                    printTmpLogs("internaledocPath =" + internaledocPath);
...
//                            }
                            ...
                            inputFileList.add(new File(identitydocPath));
                        }
...
//                            }
                            ...
                            inputFileList.add(new File(medicalphysicaledocPath));
                        }
...
//                            }
                            ...
                            inputFileList.add(new File(serviceTransPath));
                        }
...
//                            }
                            ...
                            inputFileList.add(new File(applicationedocPath));
                        }
...
//                            }
                            ...
                            inputFileList.add(new File(affidavitPath));
                        }
...
//                            }
                            ...
                            inputFileList.add(new File(securitysatedocPath));
                        }
...
//                            }
                            ...
                            inputFileList.add(new File(consentdocPath));
                        }
...
//                            }
                            ...
                            inputFileList.add(new File(internaledocPath));
                        }                        
                        
                        for(String url : ocEdocId)
                        {                            
                            if (url != null) {
                                printTmpLogs("Oc doc url :: "+url);
                        //                                try {
                        ...
                        //                                }
                                ...
                                inputFileList.add(new File(url));
                            }
                        }
...
//                        String folderPath = "/irid/oracle_files/DEV/seaf_doc/rebuild_temp/";
                        String folderPath = "/iridr/oracle_files/DR/seaf_doc/rebuild_temp/";
//                        String folderPath = "/irip/oracle_files/PROD/seaf_doc/rebuild_temp/";
...
//                        printTmpLogs("outputStream :: "+outputStream);
                        printTmpLogs("inputPdfList.size :: "+inputPdfList.size());
                        printTmpLogs("fileName :: "+fileName);
//                        mergePdfFiles(inputPdfList, outputStream);
                        mergePdfFiles(inputFileList, fileName);
                        ...
                        e.printStackTrace();
                        printTmpLogs("error 1 :: "+e.getStackTrace());
            ...
            e.printStackTrace();
            printTmpLogs("error 2 :: "+e.getStackTrace());
            AdfUtils.addFormattedFacesErrorMessage("System encountered an exception while generating supporting documents." +
                                             " Please contact your System Administrator." , 
                                             "", FacesMessage.SEVERITY_ERROR);
        }
        ...
        try
        {
            ...
            while (iteratorPDFReader.hasNext()) {
                ...
                while (currentPdfReaderPage <= pdfReader.getNumberOfPages()) {
                    ...
                    /** Added by Sushil to test page orientation 
                    document.setPageSize(pdfReader.getPageSizeWithRotation(currentPdfReaderPage));**/   
                    document.setPageSize(new Rectangle(0.0F, 0.0F, pdfImportedPage.getWidth(), pdfImportedPage.getHeight()));
                    document.newPage();                 
                    unlockPdf(pdfReader);
...
//                      }
            ...
            e.printStackTrace();
            printTmpLogs("error 3 :: "+e.getStackTrace());
...
//                                             "", FacesMessage.SEVERITY_ERROR);
    ...
    public void mergePdfFiles(List<File> files,
        ...
        try {
            ...
            System.out.println("inside new mergePdfFiles :: "+mergedFileName);
    ...
    public String processOrder()
    {
        try 
        {
            ...
            if(seafarerRow !=null && seafarerRow.getAttribute("SeafarerId") != null)
                seafarerId = seafarerRow.getAttribute("SeafarerId");
            else
                seafarerId = ADFContext.getCurrent().getPageFlowScope().get("P_PROCESS_ORDER_SEAFARER_ID");
            
            String retVal = null;
            
            printTmpLogs("P_PROCESS_ORDER_SEAFARER_ID in AM :: "+ADFContext.getCurrent().getPageFlowScope().get("P_PROCESS_ORDER_SEAFARER_ID"));
            printTmpLogs("seafarerId :: "+seafarerId);
            printTmpLogs("batchRow :: "+batchRow);            
            printTmpLogs("seafarerRow :: "+seafarerRow);            
            printTmpLogs("OeHeaderId :: "+batchRow.getAttribute("OeHeaderId"));

            if (batchRow != null && seafarerId != null && batchRow.getAttribute("OeHeaderId") != null) 
            {
                try {
                    this.getDBTransaction().commit();
                ...
                printTmpLogs("retVal for Process Order :: "+retVal);
...
//                    this.getRmiSeafarerView1().setCurrentRow(seafarerRow);
                ...
                errorVo.setNamedWhereClauseParam("pSeafarerId", Integer.parseInt(seafarerId.toString()));
                ...
                printTmpLogs("Work Order has not been generated for this batch.");
...
//                printTmpLogs("TransShipCharges :: "+lineRow.getAttribute("TransShipCharges"));                  
//                printTmpLogs("TransItemUom :: "+lineRow.getAttribute("TransItemUom"));
//                printTmpLogs("InventoryItemId :: "+lineRow.getAttribute("InventoryItemId"));
//                printTmpLogs("Context :: "+lineRow.getAttribute("Context"));
//                printTmpLogs("TransUnitQty :: "+lineRow.getAttribute("TransUnitQty"));
                ...
                try {
                    retVal = (String) callDbFunction(Types.VARCHAR, "RMI_SICD_PUB.update_line_item(?,?,?,?,?,?,?)", new Object[] {
                                                     ...
                                                     (lineRow.getAttribute("Context") != null && lineRow.getAttribute("Context").toString().equalsIgnoreCase("SHIP")) 
                                                        ? lineRow.getAttribute("InventoryItemId")
                                                        : null,
                                                     lineRow.getAttribute("TransUnitQty"),
                                                     getUserId()
                                                     });
                    System.out.println("retVal :: "+retVal);
                } catch (Exception e) {
...
//                    System.out.println("seafarerWcStatus in validateLegalNotes :: "+seafarerWcStatus);
    ...
    public String validateVerifySeafarerData()
    {
        try 
        {
            ...
            if (sfrrRow != null && sfrrRow.getAttribute("EsiId") != null) 
            {
                System.out.println("DataVerifiedInfo :: "+sfrrRow.getAttribute("DataVerifiedInfo"));
                System.out.println("PhotoVerified :: "+sfrrRow.getAttribute("PhotoVerified"));
                System.out.println("IdentityDocVerified :: "+sfrrRow.getAttribute("IdentityDocVerified"));
                System.out.println("PhysicalVerified :: "+sfrrRow.getAttribute("PhysicalVerified"));
                System.out.println("SeaserviceVerified :: "+sfrrRow.getAttribute("SeaserviceVerified"));
                System.out.println("ApplicationVerified :: "+sfrrRow.getAttribute("ApplicationVerified"));
                System.out.println("AffidavitVerified :: "+sfrrRow.getAttribute("AffidavitVerified"));
                System.out.println("SatVerified :: "+sfrrRow.getAttribute("SatVerified"));
                System.out.println("ConVerified :: "+sfrrRow.getAttribute("ConVerified"));
                System.out.println("BookVerified :: "+sfrrRow.getAttribute("BookVerified"));
                System.out.println("IdCardVerified :: "+sfrrRow.getAttribute("IdCardVerified"));
            ...
            while (ocDocRsi.hasNext()) {
                Row r = ocDocRsi.next();
                if (r != null) {
                System.out.println("DataVerified :: "+r.getAttribute("DataVerified"));
                    if ((r.getAttribute("DataVerified") == null) || 
            ...
            while (sqcDocRsi.hasNext()) {
                Row r = sqcDocRsi.next();
                if (r != null) {
                System.out.println("DataVerified1 :: "+r.getAttribute("DataVerified1"));
                    if ((r.getAttribute("DataVerified1") == null) || 
     ...
     * @return String returns the document name if found else returns Y.
     **/
    public String validateUnverifySeafarerData()
    {
        try 
        {
            ViewObjectImpl sfrrVo = this.getRmiSeafarerView1();
...
//                System.out.println("IdCardVerified :: "+sfrrRow.getAttribute("IdCardVerified"));
                ...
                if ((sfrrRow.getAttribute("DataVerifiedInfo") != null && sfrrRow.getAttribute("DataVerifiedInfo").toString().equalsIgnoreCase("No"))) {
                    return "Basic Information => Data Verified";
                }           
                if ((sfrrRow.getAttribute("PhotoVerified") != null && sfrrRow.getAttribute("PhotoVerified").toString().equalsIgnoreCase("No"))) {
                    return "Uploaded Documents => Photo Uploaded";
                }
                if ((sfrrRow.getAttribute("IdentityDocVerified") != null && sfrrRow.getAttribute("IdentityDocVerified").toString().equalsIgnoreCase("No"))) {
                    return "Uploaded Documents => Identity Document";
                }
                if ((sfrrRow.getAttribute("PhysicalVerified") != null && sfrrRow.getAttribute("PhysicalVerified").toString().equalsIgnoreCase("No"))) {
                    return "Uploaded Documents => Medical Examination Report";
                }
                if ((sfrrRow.getAttribute("SeaserviceVerified") != null && sfrrRow.getAttribute("SeaserviceVerified").toString().equalsIgnoreCase("No"))) {
                    return "Uploaded Documents => Sea Service Transcript";
                }
                if ((sfrrRow.getAttribute("ApplicationVerified") != null && sfrrRow.getAttribute("ApplicationVerified").toString().equalsIgnoreCase("No"))) {
                    return "Uploaded Documents => Application";
                }
                if ((sfrrRow.getAttribute("AffidavitVerified") != null && sfrrRow.getAttribute("AffidavitVerified").toString().equalsIgnoreCase("No"))) {
                    return "Uploaded Documents => Affidavit";
                }
                if ((sfrrRow.getAttribute("SatVerified") != null && sfrrRow.getAttribute("SatVerified").toString().equalsIgnoreCase("No"))) {
                    return "Uploaded Documents => Security Awareness";
                }
                if ((sfrrRow.getAttribute("ConVerified") != null && sfrrRow.getAttribute("ConVerified").toString().equalsIgnoreCase("No"))) {
                    return "Uploaded Documents => Data Privacy Consent";
                }
                if ((sfrrRow.getAttribute("BookVerified") != null && sfrrRow.getAttribute("BookVerified").toString().equalsIgnoreCase("No"))) {
                    return "SQC's Requested => Seafarer Book Verified";
                } 
                if ((sfrrRow.getAttribute("IdCardVerified") != null && sfrrRow.getAttribute("IdCardVerified").toString().equalsIgnoreCase("No"))) {
                    return "SQC's Requested => Seafarer ID Card Verified";
                } 
            }                 
            ...
            while (ocDocRsi.hasNext()) {
                Row r = ocDocRsi.next();
                if (r != null) {
                    if ((r.getAttribute("DataVerified") != null && r.getAttribute("DataVerified").toString().equalsIgnoreCase("No"))) {
                        return "OC's Requested => Data Verified";
                    }
                }
            }             
            ...
            while (sqcDocRsi.hasNext()) {
                Row r = sqcDocRsi.next();
                if (r != null) {
                    if ((r.getAttribute("DataVerified1") != null && r.getAttribute("DataVerified1").toString().equalsIgnoreCase("No"))) {
                        return "SQC's Requested => Data Verified";
                    }
                }
            }
...
//                                                       FacesMessage.SEVERITY_ERROR);
    ...
    public void addSqcLine()
    {
        try 
        {
            ...
            createRow.setAttribute("LineProcessedSqc", "N");
    ...
    public void saveSqcLine()
    {
        try 
        {
            ...
            if ((batchRow != null && batchRow.getAttribute("OeHeaderId") != null) &&
                ...
                Row[] unprocessedSqcLines = this.getRmiSeafarerDocsSqcView1().getFilteredRows("LineProcessedSqc", "N");
                
                System.out.println("unprocessedSqcLines.length :: "+unprocessedSqcLines.length);

                this.getDBTransaction().commit();

//                RowSetIterator docsRsi = this.getRmiSeafarerDocsSqcView1().createRowSetIterator(null);

                for (Row r : unprocessedSqcLines) 
                {
//                    Row r = docsRsi.next();
    ...
    public void approveAllDocsCerts(String value)
    {
        try 
        {
            ...
            try 
            {
                ...
                System.out.println("inside execute query message");
            }
...
//                System.out.println("searchSeafarerVo.getEstimatedRowCount :: "+searchSeafarerVo.getEstimatedRowCount());
    ...
    /**
     * Method executes the OC & SQC details views on tab click.
     **/
    public void refreshTabDetails(String refreshFor)
    {
        if(refreshFor != null && refreshFor.trim().length() > 0)
        {            
            if(refreshFor.equalsIgnoreCase("SQC"))
                this.getSqcDetailsFunctionsView1().executeQuery();
            else
                this.getOcDetailsFunctionsView1().executeQuery();
            
        }
    }

    /**
     * Method updates Notes in batch table for selected Order.
     * @param batchNotes pass notes which is to be set.
     **/
    public void updateBatchNotes(String batchNotes)
    {
        if(batchNotes != null)
        {
            Row dualHeaderRow = this.getDualEnterOrdersView1().getCurrentRow();
            
            if (dualHeaderRow != null && dualHeaderRow.getAttribute("TransEsiBatchId") != null) 
            {
                ViewObjectImpl batchVo = this.getRmiBatchView1();
                batchVo.setNamedWhereClauseParam("pEsiBatchId", dualHeaderRow.getAttribute("TransEsiBatchId"));
                batchVo.executeQuery();

                Row[] batchRow = batchVo.getAllRowsInRange();

                if (batchRow != null && batchRow[0].getAttribute("BatchName") != null) {
                    batchRow[0].setAttribute("Notes", batchNotes.trim());
                }
            }
        }
    }
    ...
    /**
     * Method updates Notes in batch table for selected Order from Assign Book Number.
     * @param batchNotes pass notes which is to be set.
     **/
    public void updateBatchNotesAssignBook(String batchNotes)
    {
        if(batchNotes != null)
        {
            Row dualBookRow = this.getDualProcessBookView1().getCurrentRow();
            
            if (dualBookRow != null && dualBookRow.getAttribute("TransEsiBatchId") != null) 
            {
                ViewObjectImpl batchVo = this.getRmiBatchView1();
                batchVo.setNamedWhereClauseParam("pEsiBatchId", dualBookRow.getAttribute("TransEsiBatchId"));
                batchVo.executeQuery();
    ...
    /**
     *  Method selects multiple books on select all.
     *  @param selectBook pass selected checkbox value for selected books.
     */
    public void selectMultipleBooks(String selectBook)
    {
        try 
        {
            if (selectBook != null) 
            {
                String retVal = "N";
                ViewObjectImpl bookDtlVo = this.getProcessBookDetailsView1();
                RowSetIterator bookDtlRsi = bookDtlVo.createRowSetIterator(null);

                while (bookDtlRsi.hasNext()) {
                    Row r = bookDtlRsi.next();

                    if (r != null && r.getAttribute("HeaderId") != null && r.getAttribute("LineId") != null) {
                        
                        r.setAttribute("TcExcluded",selectBook);
                    }
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
            AdfUtils.addFormattedFacesErrorMessage("System encountered an exception while selecting book." +
                                                   "Please contact your System Administrator.", "",
                                                   FacesMessage.SEVERITY_ERROR);
        }
    }    
    ...
    public String updateBasicInfo(String updatedValue)
    {
//        try 
//        {
//            System.out.println("updatedValue :: " + updatedValue);
//
//            if(updatedValue != null && updatedValue.toString().length() > 0)
//            {
//                Row row =
//                    (this.getRmiSeafarerView1().getCurrentRow() != null) ? this.getRmiSeafarerView1().getCurrentRow() :
//                    this.getRmiSeafarerView1().first();
//
//                row.setAttribute("BasicInfoUpd", "Y");
//                row.setAttribute("BasicInfoUpdDt", new java.sql.Timestamp(System.currentTimeMillis()));
//            }
//        } catch (Exception e) {
//            e.printStackTrace();
//            AdfUtils.addFormattedFacesErrorMessage("System encountered an exception while updating Seafarer Basic Information." +
//                                                    " Please contact your System Administrator." , 
//                                                    "", FacesMessage.SEVERITY_ERROR);
//        }
    ...
    /**
     * Container's getter for RmiBatchDetailsView1.
     * @return RmiBatchDetailsView1
     */
    public ViewObjectImpl getRmiBatchDetailsView1() {
        return (ViewObjectImpl) findViewObject("RmiBatchDetailsView1");
    }

    /**
     * Container's getter for AllCitiesView1.
     * @return AllCitiesView1
     */
    public ViewObjectImpl getAllCitiesView1() {
        return (ViewObjectImpl) findViewObject("AllCitiesView1");
    }

    /**
     * Container's getter for RmiBatchView3.
     * @return RmiBatchView3
     */
    public RmiBatchViewImpl getRmiBatchView3() {
        return (RmiBatchViewImpl) findViewObject("RmiBatchView3");
    }
}
