...
BEGIN
IF NVL(TO_CHAR(:OLD.DEPARTMENT_EXT),'X') <> NVL(TO_CHAR(:NEW.DEPARTMENT_EXT),'X')  THEN 
IF p_row_action = 'DELETE' THEN 
v_rec.TABLE_ID := :OLD.ID;
ELSE
v_rec.TABLE_ID := :NEW.ID;
END IF;
v_rec.TABLE_NAME := 'XWRL_REQUESTS';
v_rec.TABLE_COLUMN := 'DEPARTMENT_EXT';
v_rec.ROW_ACTION :=  p_row_action;
v_rec.OLD_VALUE := :OLD.DEPARTMENT_EXT;
v_rec.NEW_VALUE := :NEW.DEPARTMENT_EXT;
INSERT INTO XWRL_AUDIT_LOG values v_rec;
END IF;
END;
...
BEGIN
IF NVL(TO_CHAR(:OLD.EDQ_URL),'X') <> NVL(TO_CHAR(:NEW.EDQ_URL),'X')  THEN 
IF p_row_action = 'DELETE' THEN 
v_rec.TABLE_ID := :OLD.ID;
ELSE
v_rec.TABLE_ID := :NEW.ID;
END IF;
v_rec.TABLE_NAME := 'XWRL_REQUESTS';
v_rec.TABLE_COLUMN := 'EDQ_URL';
v_rec.ROW_ACTION :=  p_row_action;
v_rec.OLD_VALUE := :OLD.EDQ_URL;
v_rec.NEW_VALUE := :NEW.EDQ_URL;
INSERT INTO XWRL_AUDIT_LOG values v_rec;
END IF;
END;
...
BEGIN
IF NVL(TO_CHAR(:OLD.SENT_TO_LEGAL_DATE),'X') <> NVL(TO_CHAR(:NEW.SENT_TO_LEGAL_DATE),'X')  THEN 
IF p_row_action = 'DELETE' THEN 
v_rec.TABLE_ID := :OLD.ID;
ELSE
v_rec.TABLE_ID := :NEW.ID;
END IF;
v_rec.TABLE_NAME := 'XWRL_REQUESTS';
v_rec.TABLE_COLUMN := 'SENT_TO_LEGAL_DATE';
v_rec.ROW_ACTION :=  p_row_action;
v_rec.OLD_VALUE := :OLD.SENT_TO_LEGAL_DATE;
v_rec.NEW_VALUE := :NEW.SENT_TO_LEGAL_DATE;
INSERT INTO XWRL_AUDIT_LOG values v_rec;
END IF;
END;

BEGIN
IF NVL(TO_CHAR(:OLD.SENT_TO_LEGAL_BY),'X') <> NVL(TO_CHAR(:NEW.SENT_TO_LEGAL_BY),'X')  THEN 
IF p_row_action = 'DELETE' THEN 
v_rec.TABLE_ID := :OLD.ID;
ELSE
v_rec.TABLE_ID := :NEW.ID;
END IF;
v_rec.TABLE_NAME := 'XWRL_REQUESTS';
v_rec.TABLE_COLUMN := 'SENT_TO_LEGAL_BY';
v_rec.ROW_ACTION :=  p_row_action;
v_rec.OLD_VALUE := :OLD.SENT_TO_LEGAL_BY;
v_rec.NEW_VALUE := :NEW.SENT_TO_LEGAL_BY;
INSERT INTO XWRL_AUDIT_LOG values v_rec;
END IF;
END;
