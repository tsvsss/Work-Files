...
// ---    Thu Jun 13 20:05:09 EDT 2019
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class XwrlCaseNotesImpl extends EntityImpl {
    /**
    ...
    private static ADFLogger LOGGER = ADFLogger.createADFLogger(XwrlCaseNotesImpl.class);
    ...
    public static final int XWRLREQUESTS3 = AttributesEnum.XwrlRequests3.index();

    /**
     * This is the default constructor (do not remove).
     */
    public XwrlCaseNotesImpl() {
    }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("oracle.apps.xwrl.model.entity.XwrlCaseNotes");
    }
     ...
     */
    public EntityImpl getXwrlRequests() {
        return (EntityImpl) getAttributeInternal(XWRLREQUESTS);
    }

    /**
     * Sets <code>value</code> as the associated entity oracle.jbo.server.EntityImpl.
     */
    public void setXwrlRequests(EntityImpl value) {
     ...
     * @return the associated entity oracle.jbo.server.EntityImpl.
     */
    public EntityImpl getXwrlRequests3() {
        return (EntityImpl) getAttributeInternal(XWRLREQUESTS3);
    }

    /**
     * Sets <code>value</code> as the associated entity oracle.jbo.server.EntityImpl.
     */
    public void setXwrlRequests3(EntityImpl value) {
        setAttributeInternal(XWRLREQUESTS3, value);
    }
    ...
    protected void create(AttributeList attributeList) {
        ...
        id = nextVal("XWRL_CASE_NOTES_SEQ").bigDecimalValue();
        LOGGER.finest("id: " + id.toString());
        this.setId(id);
        
        lineNumber = nextVal("XWRL_CASE_NOTES_LINE_SEQ").bigDecimalValue();
       ...
       /* try {
            ...
            if (caseId != null) {
                sql =
                    "select nvl(max(line_number) ,0) + 10 line_number from xwrl_case_notes where case_id = '" + caseId +
                    "'";
                LOGGER.finest("sql: " + sql);
                rs = getDBTransaction().createStatement(0).executeQuery(sql);
                if (rs.next()) {
                    lineNumber = (BigDecimal) rs.getObject(1);
                    this.setLineNumber(lineNumber);
                }
            } else {
                lineNumber = new BigDecimal(10);
                this.setLineNumber(lineNumber);
            }
