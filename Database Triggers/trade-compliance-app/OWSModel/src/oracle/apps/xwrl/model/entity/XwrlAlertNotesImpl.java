...
// ---    Thu Jun 13 20:04:59 EDT 2019
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class XwrlAlertNotesImpl extends EntityImpl {
    /**
    ...
    private static ADFLogger LOGGER = ADFLogger.createADFLogger(XwrlAlertNotesImpl.class);
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("oracle.apps.xwrl.model.entity.XwrlAlertNotes");
    }
    ...
    public XwrlResponseEntityColumnsImpl getXwrlResponseEntityColumns() {
        return (XwrlResponseEntityColumnsImpl) getAttributeInternal(XWRLRESPONSEENTITYCOLUMNS);
    }

    /**
     * Sets <code>value</code> as the associated entity oracle.jbo.server.EntityImpl.
     */
    public void setXwrlResponseEntityColumns(XwrlResponseEntityColumnsImpl value) {
    ...
    public XwrlResponseIndColumnsImpl getXwrlResponseIndColumns() {
        return (XwrlResponseIndColumnsImpl) getAttributeInternal(XWRLRESPONSEINDCOLUMNS);
    }

    /**
     * Sets <code>value</code> as the associated entity oracle.jbo.server.EntityImpl.
     */
    public void setXwrlResponseIndColumns(XwrlResponseIndColumnsImpl value) {
    ...
    protected void create(AttributeList attributeList) {
       ...
       /* try {
            ...
            if (alertId != null) {
                sql =
                    "select nvl(max(line_number) ,0) + 10 line_number from xwrl_alert_notes where alert_id = '" +
                    alertId + "'";
